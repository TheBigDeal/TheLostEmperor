...
NAI = {
	...
	DIPLOMACY_FACTION_absolutism_PENALTY = 50,	-- Neutral nations have a separate penalty, not wanting to get involved at all, rather than caring much about the difference in ideology
	...
	CALL_ALLY_liberalism_DESIRE = 50,			-- Desire to call ally added for liberalism AI
	...
	JOIN_ALLY_liberalism_DESIRE = 50,			-- Desire to join ally added for liberalism AI
	...
	liberalism_AI_FACTION_KICKING_PLAYER_THREAT_DIFFERENCE = 6.0, -- World threat generation difference needed to kick a player from a liberalism faction
