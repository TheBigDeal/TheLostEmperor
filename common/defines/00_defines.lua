...
NCountry = {
	...
	POPULATION_YEARLY_GROWTH_BASE = 0.006,			-- basic population growth per year, used for monthly manpower gain
...
NProduction = {
	...
	BASE_FACTORY_MAX_EFFICIENCY_FACTOR = 15,	-- Base max efficiency for factories expressed in %.
